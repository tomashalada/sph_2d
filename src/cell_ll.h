...
class Cell_LL{
		...
		int cell_id;
		double edge_length;
		std::array<double, 2> left_bottom_corner_poss; // --tohle se nepouziva
		...
		void set_lbc_poss(std::array<double,2> left_bottom_corner_poss); // --tohle se nepouziva
		std::array<double, 2> get_lbc_poss(); // --tohle se nepouziva
